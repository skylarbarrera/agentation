...
export type BridgeOutgoing =
  ...
  | { type: 'overrideValueAtPath'; type: OverrideTarget; id: number; hookIndex?: number; path: Array<string | number>; value: unknown }
  | { type: 'deletePath'; type: OverrideTarget; id: number; hookIndex?: number; path: Array<string | number> }
  | { type: 'renamePath'; type: OverrideTarget; id: number; hookIndex?: number; path: Array<string | number>; oldKey: string; newKey: string }
